...
<img align="center" width="150" height="100" src="./letras2/01 - a.jpg">
<img align="center" width="150" height="100" src="./letras2/41 - e.jpg">
<img align="center" width="150" height="100" src="./letras2/50 - i.jpg">
<img align="center" width="150" height="100" src="./letras2/69 - o.jpg">
<img align="center" width="150" height="100" src="./letras2/84 - u.jpg">
...
## Definición del modelo: Regresión Logística (1 de 2)
...
## Definición del modelo: Regresión Logística (2 de 2)

```{r logistic_train, warning=FALSE}
fitted_logistic_model <- logistic_reg() %>%
  set_engine("glm") %>%
  set_mode("classification") %>%
  fit(letra ~., data = letras_train[1:5,1:100])
...
pred_class <- predict(fitted_logistic_model,
                      new_data = letras_test[1:5,1:100],
                      type = "class")
...
letras_results <- letras_test[1:5,1:100] %>%
  select(letra) %>%
...
## Definición del modelo: Clasificación K-NN (1 de 2)
...
## Definición del modelo: Clasificación K-NN (2 de 2)

```{r knn_train, warning=FALSE}
fitted_knn_model <- nearest_neighbor() %>% 
  set_engine("kknn") %>% 
  set_mode("classification") %>%
  fit(letra ~., data = letras_train[,1:100])
#  fit(letra ~., data = letras_train)
...
letras_results <- letras_test[,1:100] %>%
  select(letra) %>%
  bind_cols(pred_class, pred_proba)
#letras_results <- letras_test %>%
